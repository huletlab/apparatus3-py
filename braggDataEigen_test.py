...
if __name__ == "__main__":
  ...
  args.roi_A = [229,227,48+22,48+22]
  args.discard_A = [100,100,312,312]
  args.pixels_A=[]

  # bigger
  for i in range(233,295):
    for j in range(231,291):
  ...
  def parallel_analyze2(new):
	for i in new:
		print "analyzing",i
		thread.start_new_thread(analyze_shot,(i,args))
  while (1):
